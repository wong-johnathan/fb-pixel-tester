import type { FbEvent } from "../types";

export const fbEvents: FbEvent[] = [
  {
    name: "Purchase",
    description: "When a purchase is made",
    parameters: [
      { name: "content_ids", description: "(seperate fields with ,)", type: "string" },
  ...
  },
  {
    ...
    parameters: [{ name: "content_name", type: "string" }],
  },
  {
    name: "Lead",
  ...
  { name: "AddPaymentInfo", description: "When payment information is added", parameters: [] },
  {
    name: "AddToWishlist",
